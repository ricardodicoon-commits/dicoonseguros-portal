...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Solvent — CRM para corretores de seguros" },
      { name: "description", content: "Multicálculo, comparador inteligente e pipeline para corretoras." },
      { name: "author", content: "Solvent" },
      { property: "og:title", content: "Solvent — CRM para corretores de seguros" },
      { property: "og:description", content: "Multicálculo, comparador inteligente e pipeline para corretoras." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Solvent — CRM para corretores de seguros" },
