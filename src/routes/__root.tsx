...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "dicoon seguros — corretores de seguros" },
      ...
      { property: "og:title", content: "dicoon seguros — corretores de seguros" },
      { property: "og:description", content: "Multicálculo, comparador inteligente e pipeline para corretoras." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "dicoon seguros — corretores de seguros" },
